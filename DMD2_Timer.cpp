...
void scan(struct tc_module *const module_inst);

#if defined (ARDUINO_SAMD_MKR1000)
//4, ISR_timer4_LED2, 5e5
//SAMDtimer timer3_1Hz = SAMDtimer(3, TC_COUNTER_SIZE_16BIT, 5, 4167, 1041);
SAMDtimer timer3_1Hz = SAMDtimer(4, scan, 900);
#endif
...
void BaseDMD::begin()
{
  ...
  timer3_1Hz.enableInterrupt(0);

  //timer0_detachInterrupt();

  register_running_dmd(this);

  timer3_1Hz.enableTimer(1);
  //timer3_1Hz.setPulseWidth(100);
  timer3_1Hz.attachInterrupt(scan);
